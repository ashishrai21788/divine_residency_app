...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final StethoLibraryAccessors laccForStethoLibraryAccessors = new StethoLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>compiler</b> with <b>android.arch.persistence.room:compiler</b> coordinates and
    ...
    /**
     * Group of libraries at <b>stetho</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public StethoLibraryAccessors getStetho() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForStethoLibraryAccessors;
    }
    ...
    public static class AndroidxLifecycleViewmodelKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v250</b> with <b>androidx.lifecycle:lifecycle-viewmodel-ktx</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV250() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.lifecycle.viewmodel.ktx.v250");
        }
    ...
    public static class DaggerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>daggerAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class StethoLibraryAccessors extends SubDependencyFactory {

        public StethoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>okhttp3</b> with <b>com.facebook.stetho:stetho-okhttp3</b> coordinates and
         * with version reference <b>stethoOkhttp3</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>adapterRxjava2</b> with value <b>2.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>compilerVersion</b> with value <b>4.14.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>daggerAndroid</b> with value <b>2.51.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDaggerAndroid() { return getVersion("daggerAndroid"); }
        ...
        /**
         * Version alias <b>firebaseMessagingKtx</b> with value <b>25.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleViewmodelKtxVersion</b> with value <b>2.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>roomRuntime</b> with value <b>2.7.0-alpha04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>stethoOkhttp3</b> with value <b>1.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStethoOkhttp3() { return getVersion("stethoOkhttp3"); }
