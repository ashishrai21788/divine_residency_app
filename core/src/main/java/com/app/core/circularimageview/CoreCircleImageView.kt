package com.app.core.circularimageview
...
class CoreCircleImageView : AppCompatImageView {
    ...
    constructor(
        ...
        val a =
            context.obtainStyledAttributes(attrs, R.styleable.CoreCircleImageView, defStyle, 0)
        mBorderWidth = a.getDimensionPixelSize(
            R.styleable.CoreCircleImageView_civ_border_width,
            DEFAULT_BORDER_WIDTH
        )
        mBorderColor = a.getColor(
            R.styleable.CoreCircleImageView_civ_border_color,
            DEFAULT_BORDER_COLOR
        )
        mBorderOverlay = a.getBoolean(
            R.styleable.CoreCircleImageView_civ_border_overlay,
            DEFAULT_BORDER_OVERLAY
        )
        mCircleBackgroundColor = a.getColor(
            R.styleable.CoreCircleImageView_civ_circle_background_color,
            DEFAULT_CIRCLE_BACKGROUND_COLOR
        )
        a.recycle()
        init()
