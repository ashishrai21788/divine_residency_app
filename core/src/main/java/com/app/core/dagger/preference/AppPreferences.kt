package com.app.core.dagger.preference
...
class AppPreferences(context: Context) {
    ...
    init {
        sharedPref = context.getSharedPreferences(APP_SHARED_PREF_KEY, Context.MODE_PRIVATE)
    }
    ...
    fun getArrayList(key: String): MutableList<String> {
        ...
        return arrayListOf() //(json.convertIntoModels(type) ?: listOf()).toMutableList()
    ...
    fun getPermissionMapValue(key: String):String?{
        return sharedPref.getString(key, null)
    }

    fun setPermissionMapValue(key: String,value: String){
        val editor = sharedPref.edit()
